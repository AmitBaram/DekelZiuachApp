...
namespace DekelApp.ViewModels
{
    public class TichumViewModel : BaseViewModel
    {
        ...
        public ObservableCollection<CoordinateModel> Coordinates => _appData.TichumCoordinates;
        ...
        private void UploadFile()
        {
            ...
            {
                _appData.IsTichumFileUploaded = true;
                _appData.TichumFilePath = openFileDialog.FileName;
